...
import 'calender_strip_date_utils.dart';
...
class CalendarStripState extends State<CalendarStrip>
  ...
  CalendarStripState(
    ...
    lastDayOfMonth = CalenderStripDateUtils.getLastDayOfMonth(currentDate);
  ...
  int getLastDayOfMonth(rowStartingDay) {
    return CalenderStripDateUtils.getLastDayOfMonth(

...
class DatabaseRepository {
  ...
  //   QuerySnapshot querySnap = await _searchEventsCollection.where('category', isGreaterThanOrEqualTo: 'Suggested').get();
  //   return querySnap.docs.map((doc) => SearchResultModel(
